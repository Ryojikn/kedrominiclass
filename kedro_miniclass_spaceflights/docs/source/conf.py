...
# kedro_miniclass_spaceflights documentation build
...
from kedro_miniclass_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_miniclass_spaceflights"
author = "Kedro"
...
htmlhelp_basename = "kedro_miniclass_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_miniclass_spaceflights.tex",
        "kedro_miniclass_spaceflights Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_miniclass_spaceflights",
        "Project kedro_miniclass_spaceflights codebase.",
        "Data-Science",
    )
]
